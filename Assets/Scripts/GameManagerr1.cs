...
public class GameManagerr1 : MonoBehaviour
{
    /// <summary>
    ...
    public GameObject GameManagerr2;
    ...
    void Start()
    {
        ...
        GameObject otherGameManager1 = GameObject.Find("GameManagerr2");
    }
