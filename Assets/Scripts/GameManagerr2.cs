...
public class GameManagerr2 : MonoBehaviour
{
    /// <summary>
    public TextMeshProUGUI Text;
    /// </summary>

    public GameObject GameManagerr3;
    ...
    public IEnumerator SwitchPlayer2()
    {
      //  if (switchingPlayer)
      //  {
      //      yield break;
    ...
    void Start()
    {
        ...
        GameObject otherGameManager1 = GameObject.Find("GameManagerr3");
